...
{
    public class SupportListView : ListView
    {
        public SupportListView() : this(ListViewCachingStrategy.RecycleElement)
        {
        }

        public SupportListView(ListViewCachingStrategy cachingStrategy) : base(cachingStrategy)
        {
        ...
        public static readonly BindableProperty TappedCommandProperty = BindableProperty.Create(nameof(TappedCommand), typeof(ICommand), typeof(SupportListView), default(ICommand));
        ...
        public static readonly BindableProperty ItemAppearingCommandProperty = BindableProperty.Create(nameof(ItemAppearingCommand), typeof(ICommand), typeof(SupportListView), default(ICommand));
        ...
        public static readonly BindableProperty ItemDisappearingCommandProperty = BindableProperty.Create(nameof(ItemDisappearingCommand), typeof(ICommand), typeof(SupportListView), default(ICommand));
        ...
        {
            var listView = (SupportListView)sender;
            if (e == null) 
                return;
