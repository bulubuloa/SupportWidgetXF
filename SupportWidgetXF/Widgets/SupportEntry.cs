...
namespace SupportWidgetXF.Widgets
{
    public class SupportEntry : Entry
    {
        ...
        public static readonly BindableProperty ReturnTypeProperty = BindableProperty.Create(nameof(ReturnType), typeof(SupportEntryReturnType), typeof(SupportEntry), SupportEntryReturnType.Done, BindingMode.OneWay);
        ...
        public static readonly BindableProperty CurrentCornerColorProperty = BindableProperty.Create("CurrentCornerColor", typeof(Color), typeof(SupportEntry), Color.Default);
