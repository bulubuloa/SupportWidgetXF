...
[assembly: ExportRenderer(typeof(SupportHtmlLabel), typeof(SupportHtmlLabelRenderer))]
...
namespace SupportWidgetXF.Droid.Renderers
{
    ...
    public class SupportHtmlLabelRenderer : LabelRenderer
    {
        /// <summary>
        /// 
        /// </summary>
        /// <param name="context"></param>
        public SupportHtmlLabelRenderer(Android.Content.Context context) : base(context) { }
        ...
        protected override void OnElementPropertyChanged(object sender, PropertyChangedEventArgs e)
        {
            ...
            if (e.PropertyName == SupportHtmlLabel.MaxLinesProperty.PropertyName)
                UpdateMaxLines();
...
#pragma warning restore 618
        ...
        private void MakeLinkClickable(ISpannable strBuilder, URLSpan span)
        {
            ...
            var clickable = new MyClickableSpan((SupportHtmlLabel)Element, span);
        ...
        {
            private readonly SupportHtmlLabel _label;
